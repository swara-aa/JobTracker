...
DIGEST_SEND_TIME = os.getenv("JOBTRACKER_DIGEST_SEND_TIME", "09:15")
DIGEST_LATEST_SEND_TIME = os.getenv("JOBTRACKER_DIGEST_LATEST_SEND_TIME", "09:30")
DIGEST_TIMEZONE = os.getenv("JOBTRACKER_DIGEST_TIMEZONE", "America/Chicago")
DIGEST_MIN_SCORE = max(0, min(100, int(os.getenv("JOBTRACKER_DIGEST_MIN_SCORE", "90"))))
